  ...
  return (
    <div className="max-w-2xl p-8 mx-auto">
      ...
      <div className="p-8 bg-white rounded-lg shadow-lg">
        ...
        {!isPro && <button onClick={handleUpgrade} disabled={isLoading} className="w-full px-6 py-3 mt-8 font-semibold text-white bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50">{isLoading ? 'Upgrading...' : 'Upgrade Now ($5/mo)'}</button>}
      </div>
    </div>
  );
}
